      ...
      <form className="flex flex-col items-center">
        <section className="flex flex-col w-full max-w-lg gap-20 mt-8">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <div className="flex justify-between w-3/4">
              <p className="text-xl font-bold text-mainColor">거주지 형태</p>
              <select id="dwelling" className="bg-gray-50 border-2 border-mainColor text-gray-900 text-lg focus:ring-blue-500 focus:border-blue-500 block w-fit p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div className="flex justify-between w-3/4">
              <p className="text-xl font-bold text-mainColor">산책 가능 여부</p>
              <select id="walk" className="bg-gray-50 border-2 border-mainColor text-gray-900 text-lg focus:ring-blue-500 focus:border-blue-500 block w-fit p-1.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
