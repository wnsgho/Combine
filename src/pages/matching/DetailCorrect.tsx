      ...
      <div className="flex flex-col items-center mt-10">
        ...
        <section className="flex flex-col w-full max-w-lg gap-8 mt-8">
          <div className="flex justify-between w-full">
            ...
            <select id="species" className="text-lg border-2 bg-gray-50 border-mainColor" value={petInfo.species}>
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <div className="flex justify-between w-full">
              ...
              <input type="text" id="reason" placeholder="예) 코코, 까미" className="w-40 text-lg"/>
            </div>
          </div>
          <div className="flex justify-between w-full">
          ...
          <div className="flex justify-between w-full">
            ...
            <select id="gender" className="text-lg border-2 bg-gray-50 border-mainColor">
          ...
          <div className="flex justify-between w-full">
            ...
            <select id="inoculation" className="text-lg border-2 bg-gray-50 border-mainColor">
          ...
          <div className="flex justify-between w-full">
            ...
            <select id="neutering" className="text-lg border-2 bg-gray-50 border-mainColor">
