      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="max-w-[1000px] mx-auto">
          <div className="bg-[#3c2a13]/90 p-8 rounded-xl">
            <select className="mb-6 w-auto p-2 font-bold rounded-xl"
            onChange={(e) => setCategory(e.target.value)}>
              <option value="NOTICE">공지</option>
              <option value="SUPPORT">지원</option>
            </select>
            <div className="mb-6">
              <input type="text" className="w-full p-3 rounded-xl" placeholder="제목을 입력하세요" value={title} onChange={(e) => setTitle(e.target.value)}/>
            </div>
